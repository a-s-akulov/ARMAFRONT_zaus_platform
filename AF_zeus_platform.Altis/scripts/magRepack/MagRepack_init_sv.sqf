...
[] execVM "scripts\magRepack\Scripts\MagRepack_Main.sqf";
[] execVM "scripts\magRepack\Scripts\MagRepack_Keybindings.sqf";
[] execVM "scripts\magRepack\Scripts\MagRepack_Misc.sqf";
...
hint parseText format ["<br/><img size='4' color='#595923' image='pictures\hint_pic\reload_ca.paa' align='center'/><br/><br/>
<t size='1.2' color='#99ffffff' align='center'>Система перепаковки магазинов инициализирована</t><br/><br/>
<t size='1.2' color='#99ffffff' align='center'>Используйте: 
<t size='1.2' color='#ff0000' align='center'>%1</t><br/><br/>",(call outlw_MR_keyListToString)];