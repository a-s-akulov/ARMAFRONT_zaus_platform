...
class TAW_VDMenu {
	...
	class controlsBackground {
		...
		class SaveManagerBtn : RscButtonMenu {
			idc = 295009;
			text = "Saves";
	...
	class controls {
		...
		class VD_terrain_normal : VD_terrain_low {
			idc = 29502;
			text = "Standart";
		...
		class VD_terrain_high : VD_terrain_low {
			idc = 29503;
			text = "High";
